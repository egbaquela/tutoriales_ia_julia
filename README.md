...
Conjunto de aputnes y tutoriales de la materia "Inteligencia artificial aplicada a la ingeniería", de la [Facultad Regional San Nicolás - Universidad Tecnológica Nacional](https://www.frsn.utn.edu.ar/) (FRSN-UTN).
...
**Con DOI (preferido):**  
Baquela, E. G. (2025). *Tutoriales de Inteligencia Artificial con Julia* (v0.0.1-alpha) [Repositorio y materiales]. GitHub; Zenodo. https://doi.org/10.5281/zenodo.1798805  
...
@software{Baquela_Tutoriales_IO_Julia_2025,
  ...
  year      = {2025},
  month     = {12},
  url       = {https://github.com/egbaquela/tutoriales_ia_julia},
  note      = {Repositorio y materiales educativos (Julia, MLJ)}
}
